                ...
                'entity_resolutions': [
                    {
                        ...
                        'duplicate_name': 'Budget pending on POC',
                    }
                ]
            }
        )
            ...
            'entity_resolutions': [
                {
                    ...
                    'duplicate_name': 'Project Alpha',
                },
                {
                    'id': 1,
                    'name': 'Project Alpha Phase Two',
                    'duplicate_name': 'Project Alpha Phase Two',
                },
            ]
        }
    )
